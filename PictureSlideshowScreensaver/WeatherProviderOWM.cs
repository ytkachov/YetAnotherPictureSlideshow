...
namespace weather
{
  ...
  // http://api.openweathermap.org/data/2.5/weather?lat=54.85&lon=83.11&mode=xml&appid=apikey
  // http://api.openweathermap.org/data/2.5/forecast?lat=54.85&lon=83.11&mode=xml&appid=apikey

  class WeatherProviderOWM : WeatherProviderBase
  {
    static string _owm_key = "385905f2084606351e831eae38c2247d";
    ...
    protected override void readdata()
    {
      while (true)
      {
        try
        {
          ...
          //current conditions 
          forecast.Load("http://api.wunderground.com/api/" + _owm_key + "/conditions/q/Russia/Novosibirsk.xml");
          ...
          forecast.Load("http://api.wunderground.com/api/" + _owm_key + "/hourly10day/q/Russia/Novosibirsk.xml");
